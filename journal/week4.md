...
```shell
psql -U postgres --host localhost # default password is password

# Connect a db quickly
...
We can use the createdb (https://www.postgresql.org/docs/current/app-createdb.html) command to create our database:
